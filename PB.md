...
- **Backlog/Cần làm thêm:**
  - [ ] Tạo trang chi tiết `/details` (Hiện tại click "Xem Thêm" sẽ trỏ sang trang này nhưng chưa được khởi tạo).
...
- **Trạng thái:** ✅ **Đã hoàn thành luồng Form Wizard**
- **Backlog/Cần làm thêm:**
  - [ ] Kết nối API gửi dữ liệu khảo sát về CRM/Backend của HQSOFT.
...
- **Trạng thái:** ✅ **Đã hoàn thành validation phía client**
- **Backlog/Cần làm thêm:**
  - [ ] Kết nối API POST lên server để lưu trữ thông tin lead đăng ký tư vấn.
...
2. **Xây dựng trang `/details`:**
   - Tạo thư mục `app/details/page.tsx` để hiển thị thêm thông tin giải pháp chi tiết nếu khách hàng muốn tìm hiểu sâu.
3. **Thay thế hình ảnh mockup thực tế:**
