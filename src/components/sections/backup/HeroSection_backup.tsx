    ...
    <section className="min-h-screen pt-16 flex flex-col bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex-1 flex flex-col">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="font-bold text-slate-900 leading-tight max-w-4xl mx-auto flex flex-col items-center">
            <span className="whitespace-nowrap text-[20px] sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500" lang="vi">
              KIẾN TẠO CHUỖI PHÂN PHỐI THÔNG MINH
            </span>
          </motion.h1>

          <motion.p variants={itemVariants} className="mt-6 text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed whitespace-nowrap" lang="vi">
        ...
        <motion.div variants={itemVariants} className="mt-6 flex justify-center">
          <a href="/details" className="cta-primary px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-sm transition-colors duration-200">
            Xem Thêm
          </a>
        </motion.div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex-1">
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-slate-700 mb-5">
                  Đang Kẹt Trong “Bẫy” Vận Hành?
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <TrendingDown className="text-slate-500 mt-0.5 shrink-0" size={18} strokeWidth={1.5} />
                    <p className="text-sm text-slate-600">
                      <span className="font-semibold text-slate-700">Mù mờ ngân sách:</span>{' '}Thiếu công cụ đo lường ROI Trade MKT.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <Database className="text-slate-500 mt-0.5 shrink-0" size={18} strokeWidth={1.5} />
                    <p className="text-sm text-slate-600">
                      <span className="font-semibold text-slate-700">Dữ liệu phân mảnh:</span>{' '}Báo cáo tồn kho chậm, kẹt trên Excel.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <MapPin className="text-slate-500 mt-0.5 shrink-0" size={18} strokeWidth={1.5} />
                    <p className="text-sm text-slate-600">
                      <span className="font-semibold text-slate-700">Khó quản lý đi tuyến:</span>{' '}Thiếu công cụ giám sát lộ trình thực tế.
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-slate-600">
                      <span className="font-semibold text-slate-900">Tối ưu Trade MKT:</span>{' '}Tracking hiệu quả khuyến mãi Real-time.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <Network className="text-cyan-600 mt-0.5 shrink-0" size={18} strokeWidth={1.5} />
                    <p className="text-sm text-slate-600">
                      <span className="font-semibold text-slate-900">Dữ liệu tập trung:</span>{' '}Báo cáo tự động, ra quyết định tức thì.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <Smartphone className="text-cyan-600 mt-0.5 shrink-0" size={18} strokeWidth={1.5} />
                    <p className="text-sm text-slate-600">
                      <span className="font-semibold text-slate-900">Giám sát thông minh:</span>{' '}Quản lý lộ trình trực tiếp trên Mobile.
                    </p>
                  </li>
                </ul>
